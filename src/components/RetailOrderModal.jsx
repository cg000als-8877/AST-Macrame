              ...
              <div className="py-2 md:py-4 flex flex-col items-center justify-center w-full max-w-sm sm:max-w-md mx-auto">
                ...
                <div className="flex flex-col items-center justify-center w-full max-w-sm sm:max-w-md mx-auto mt-4">
                  <button 
                    ...
                    className="w-full bg-[#1C2841] text-white hover:bg-black px-8 py-3.5 text-xs sm:text-sm font-bold uppercase tracking-wider rounded transition-all shadow-xl cursor-pointer flex items-center justify-center gap-2.5 active:scale-95 disabled:opacity-75"
                  >
                    {downloadSuccess ? (
                      <>
                ...
                >
                  ...
                  <div className="md:hidden pt-4 mt-4 w-full flex flex-col gap-3">
                    ...
                    <button 
                      ...
                      className="w-full bg-black text-white px-2 sm:px-4 py-3.5 text-[10.5px] min-[360px]:text-[11.5px] sm:text-xs font-bold uppercase tracking-tight sm:tracking-wider rounded hover:bg-neutral-800 transition-colors shadow-lg active:scale-[0.99] disabled:opacity-75 disabled:cursor-wait whitespace-nowrap overflow-hidden flex items-center justify-center gap-1 cursor-pointer"
                    >
                      {isSubmitting ? (
                        'Processing...'
                      ) : (
                  ...
                  <div className="hidden md:flex flex-col pt-4 mt-auto gap-3">
                    ...
                    <button 
                      type="submit" 
                      disabled={isSubmitting} 
                      className="w-full bg-black text-white px-4 py-4 text-xs lg:text-sm font-bold uppercase tracking-wider rounded hover:bg-neutral-800 transition-colors shadow-lg active:scale-[0.99] disabled:opacity-75 disabled:cursor-wait whitespace-nowrap flex items-center justify-center gap-1.5 cursor-pointer"
                    >
                      {isSubmitting ? (
                        'Processing...'
                      ) : (
