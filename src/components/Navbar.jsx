        ...
        {isRetailPage ? (
          <div className="px-3 sm:px-6 h-12 md:h-14 grid grid-cols-3 items-center w-full">
            ...
            <div className="flex justify-start">
              <Link to="/sample-wholesale" className="text-[9px] sm:text-[10px] md:text-xs font-bold tracking-[0.1em] sm:tracking-widest uppercase text-white bg-soft-black hover:bg-dark-charcoal active:scale-95 transition-all shadow-sm px-3 py-1.5 sm:px-4 sm:py-2 rounded-full">
                Wholesale
              </Link>
            </div>
            ...
            <div className="flex justify-end gap-1.5 sm:gap-2">
              <a href="mailto:astmacrame@gmail.com" className="w-7 h-7 md:w-9 md:h-9 bg-soft-black text-white rounded-full flex items-center justify-center hover:bg-dark-charcoal active:scale-95 transition-all shadow-md" aria-label="Mail">
