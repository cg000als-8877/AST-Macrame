...
const Footer = () => {
  return (
    <footer className="bg-soft-black text-cream pt-16 pb-28 sm:pb-8">
          ...
          <div className="grid grid-cols-3 gap-x-2 gap-y-10 lg:grid-cols-4 lg:gap-8 lg:col-span-3">
            ...
            <div className="col-span-3 lg:col-span-1 flex flex-col items-center text-center mt-2 lg:mt-0 pt-6 lg:pt-0 border-t border-cream/10 lg:border-none lg:items-start lg:text-left">
              ...
              <ul className="flex justify-center lg:justify-start gap-4">
                ...
                <li>
                  <a href="https://www.instagram.com/ast.macrame" target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full border border-cream/20 text-cream/80 hover:bg-[#E4405F] hover:border-[#E4405F] hover:text-white transition-all" aria-label="Instagram">
