            ...
            <div className="lg:col-span-7 flex flex-col justify-center text-left">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-3.5 sm:gap-4 items-stretch sm:items-center mb-10 sm:mb-12">
                  <Link 
                    to="/sample-order"
                    className="bg-soft-black text-cream px-8 py-4 text-xs font-bold uppercase tracking-[0.2em] rounded-full hover:bg-dark-charcoal hover:text-white transition-all shadow-md hover:shadow-xl text-center inline-flex items-center justify-center gap-2 group"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="bg-transparent border border-soft-black/30 text-soft-black px-8 py-4 text-xs font-bold uppercase tracking-[0.2em] rounded-full hover:bg-soft-black hover:text-cream hover:border-soft-black transition-all text-center inline-flex items-center justify-center gap-2"
                  >
            ...
            {pricingTiers.map((tier, idx) => (
              ...
              >
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className={`w-full py-3 text-center text-xs font-bold uppercase tracking-[0.15em] rounded-full transition-all block ${
                    tier.popular 
      ...
      <section className="py-16 md:py-24 bg-white border-b border-stone/15">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
          ...
          <div className="text-center mt-10 sm:mt-12">
            <Link 
              to="/sample-order" 
              className="bg-soft-black text-cream px-9 py-4 text-xs font-bold uppercase tracking-[0.2em] rounded-full hover:bg-dark-charcoal transition-all shadow-md inline-block"
            >
